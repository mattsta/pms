...
from pms.models.enums import ProgramStatus
from pms.models.json_types import ModelObject


@dataclass
class Program(BaseModel):
    """Program entity grouping projects and goals under a portfolio."""
    ...
    def add_direct_goal(self, goal_id: str) -> Self:
        """Add a direct goal link to the program."""
    ...
    def remove_direct_objective(self, objective_id: str) -> Self:
        """Remove a direct objective link from the program."""
...
@dataclass
class ProgramStats:
    """Rollup statistics for a program."""
